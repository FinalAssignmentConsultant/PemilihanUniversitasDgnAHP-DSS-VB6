...
Public Class NilaiUniversitasPadaKriteria
    ...
    Private Sub NilaiUniversitasPadaKriteria_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'TODO: This line of code loads data into the 'AhpUniversitasDataSet.directentry' table. You can move, or remove it, as needed.
        Me.DirectentryTableAdapter.Fill(Me.AhpUniversitasDataSet.directentry)
