Module Module1
    Public con As OleDb.OleDbConnection = New OleDb.OleDbConnection("Provider=Microsoft.Jet.OLEDB.4.0;Data Source=D:\files\skripsi\aplikasi\Database\AhpUniversitas.mdb")
    ...
    Public Sub persiapkanAdmin(ByVal enabled As Boolean)
        Dim c As Control


        For Each c In FormUtama.tabPageKriteria1.Controls
